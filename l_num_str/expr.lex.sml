        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ22(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ12(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
              else yyAction23(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction13(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction13(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction15(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction15(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction10(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction10(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction14(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction14(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction11(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction11(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ12(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
              else yyAction23(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction12(strm, yyNO_MATCH)
                      else yyQ12(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
                else if inp <= #"?"
                  then yyAction12(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp = #"`"
